...
class compute_error_yancheng:
    def __init__(self):
        self.plot_classes = ['contrast_detection_SpF_Gabor_ach', 'contrast_detection_SpF_Noise_ach',
                             ...
                             'contrast_matching_cos_scale', 'contrast_matching_cos_scale_solve',
                             'contrast_matching_cos_scale_solve_no_scaler', 'contrast_matching_rafal_cos']
            ...
            if plot_test not in self.plot_classes:
                ...
                for model_name in tqdm(all_model_list):
                    ...
                    for backbone_name in backbone_name_list:
                        ...
                        log_RMSE_loss = root_mean_squared_error(np.log10(human_result_array).flatten(),
                                                                np.log10(model_prediction_result_array).flatten())
                        print(plot_test, model_name, backbone_name)
