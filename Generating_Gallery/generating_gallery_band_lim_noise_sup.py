...
# plt.show()
# plt.savefig('Band_limited_noise_SpF_Contrast_sup.png', dpi=300)
# plt.savefig('Real_sup/Noise_SpF_Contrast_supplementary.svg', dpi=300)
plt.savefig('Sup_pngs/Noise_SpF_Contrast_supplementary.png', dpi=300)
plt.close()