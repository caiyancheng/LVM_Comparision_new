...
fig, axes = plt.subplots(size_of_gallery[0], size_of_gallery[1], figsize=(10, 10))
plt.subplots_adjust(left=0.08, right=0.997, top=0.92, bottom=0.003, wspace=0.04, hspace=0.04)
...
# 在左侧添加纵向箭头
fig.text(0.007, 0.5, 'Contrast Test', va='center', rotation='vertical', fontsize=20)
fig.text((0.08+0.997)/2, 0.97, 'Contrast Mask', ha='center', fontsize=20)
...
# plt.show()
plt.savefig('Contrast_Masking_Band_limit_noise.png')
plt.close()