...
default_O = 0
default_contrast = 1
L_b_list = np.logspace(np.log10(1), np.log10(200), size_of_gallery[1])
default_ppd = 60
...
# plt.show()
# plt.savefig('Real_sup/Gabor_Luminance_Contrast_supplementary.svg', dpi=300)
plt.savefig('Sup_pngs/Gabor_Luminance_Contrast_supplementary.png', dpi=300)
plt.close()