...
fig, axes = plt.subplots(size_of_gallery[0], size_of_gallery[1], figsize=(8, 2))#, dpi=300)
if size_of_gallery[0] == 1:
    axes = [axes]
plt.subplots_adjust(left=0.08, right=0.999, top=0.85, bottom=0.001, wspace=0.04, hspace=0.04)
...
fig.text((0.08+0.997)/2, 0.945, 'Radius (visual degree)', ha='center', fontsize=20)

# 添加从左到右的箭头（横轴）
plt.annotate('', xy=(0.997, 0.92), xytext=(0.08, 0.92),
...
plt.show()
# plt.savefig('Gabor_Area_Contrast_2.png', dpi=300)
plt.close()