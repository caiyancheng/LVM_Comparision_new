...
default_rho = 8
contrast_list = np.logspace(np.log10(0.01), np.log10(1), size_of_gallery[0]) #每行是不同的Contrast
default_O = 0
default_contrast = 1
default_L_b = 100
default_ppd = 60
...
# plt.savefig('Real_sup/Gabor_Area_Contrast_supplementary.svg', dpi=300)
plt.savefig('Sup_pngs/Gabor_Area_Contrast_supplementary.png', dpi=300)
plt.close()