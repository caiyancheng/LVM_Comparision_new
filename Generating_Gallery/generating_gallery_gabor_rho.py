...
fig, axes = plt.subplots(size_of_gallery[0], size_of_gallery[1], figsize=(11, 10), dpi=300)
plt.subplots_adjust(left=0.15, right=0.999, top=0.92, bottom=0.001, wspace=0.04, hspace=0.04)
...
fig.text(0.09, 0.5, 'Contrast', va='center', rotation='vertical', fontsize=20)
fig.text((0.08+0.997)/2, 0.975, 'Spatial Frequency (cpd)', ha='center', fontsize=20)

# 添加从左到右的箭头（横轴）
plt.annotate('', xy=(0.997, 0.955), xytext=(0.15, 0.955),
             arrowprops=dict(facecolor='black', shrink=0.05),
             xycoords='figure fraction')

# 添加从上到下的箭头（纵轴）
plt.annotate('', xy=(0.12, 0.003), xytext=(0.12, 0.92),
             arrowprops=dict(facecolor='black', shrink=0.05),
             xycoords='figure fraction')
plt.annotate('', xy=(0.07, 0.92), xytext=(0.07, 0.003),
             arrowprops=dict(facecolor='black', shrink=0.05),
             xycoords='figure fraction')
...
# plt.savefig('Gabor_SpF_Contrast_sup.svg', dpi=300)
plt.close()