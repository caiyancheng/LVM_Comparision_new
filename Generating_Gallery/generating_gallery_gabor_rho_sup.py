...
contrast_list = np.logspace(np.log10(0.01), np.log10(1), size_of_gallery[0])
default_O = 0
default_L_b = 100
default_ppd = 60
...
# plt.savefig('Real_sup/Gabor_SpF_Contrast_supplementary.svg', dpi=300)
plt.savefig('Sup_pngs/Gabor_SpF_Contrast_supplementary.png', dpi=300)
plt.close()