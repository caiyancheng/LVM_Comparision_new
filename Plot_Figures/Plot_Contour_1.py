...
sub_model_list = [None, None, 'dinov2_vitl14', 'ppd_60/sam2.1_hiera_large', 'stable-diffusion-xl-base-1.0', 'ViT-B-16 - laion2b_s34b_b88k']
file_name_list = ['cos similarity - baseline.png', 'JOD Score - cvvdp.png', 'cos similarity - dinov2.png', 'cos similarity - sam2 - ppd_60.png', 'cos similarity - vae.png', 'cos similarity - openclip.png']
