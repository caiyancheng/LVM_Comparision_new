...
Y_Alignment_score_dimensions = ['Phase-Coherent Masking', 'Contrast Matching']
...
fig, axes = plt.subplots(len(X_dimensions), len(Y_Alignment_score_dimensions), figsize=(len(Y_Alignment_score_dimensions) * 4, len(X_dimensions) * 3))
