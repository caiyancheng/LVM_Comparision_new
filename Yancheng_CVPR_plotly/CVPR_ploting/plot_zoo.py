...
class plot_yancheng:
    def __init__(self, figure_size=(4.3,3), dpi=300, level_num=50):
        ...
        self.gt_json_dict = {
            ...
            'contrast_masking_phase_incoherent_masking': ['gt_json/foley_contrast_masking_data_gabor.json', 'mask_contrast_list', 'test_contrast_list'],
            'contrast_matching_cos_scale': 'gt_json/contrast_constancy_sin_5_cpd.json',
            'contrast_matching_cos_scale_solve': 'gt_json/contrast_constancy_sin_5_cpd.json',
            'contrast_matching_rafal_cos': 'gt_json/contrast_constancy_sin_5_cpd.json',
        }
        self.plot_json_dict = {
        ...
        self.plot_ticks_label_dict = {
            ...
            'contrast_matching_cos_scale': [[0.25, 0.5, 1, 2, 4, 8, 16], [0.001, 0.01, 0.1, 1], 'Test Spatial Frequency (cpd)', 'Test Contrast'],
            'contrast_matching_cos_scale_solve': [[0.25, 0.5, 1, 2, 4, 8, 16], [0.001, 0.01, 0.1, 1], 'Test Spatial Frequency (cpd)', 'Test Contrast'],
            'contrast_matching_rafal_cos': [[0.25, 0.5, 1, 2, 4, 8, 16], [0.001, 0.01, 0.1, 1], 'Test Spatial Frequency (cpd)', 'Test Contrast'],
        }
        # self.plot_score_name_list = [['L1_similarity_matrix', 'L2_similarity_matrix', 'cos_similarity_matrix', 'arccos_cos_similarity_matrix'],
        #                              ['JOD_matrix', 'JOD_scale_matrix']]
